...
const FilterModal = ({ isModalOpen, setIsModalOpen }: filterModalInterface) => {

    let [propertyPrice, setPropertyPrice] = useState<number>()
    let [numberOfRooms, setNumberOfRooms] = useState<string>()
    let [numberOfBathrooms, setNumberOfBathrooms] = useState<string>()
    let [area, setArea] = useState<string>()

    const updatePropertyPrice = (data: number) => setPropertyPrice(data)
    const updateNumberOfRooms = (data?: string) => setNumberOfRooms(data)
    const updateNumberOfBathrooms = (data?: string) => setNumberOfBathrooms(data)
    const updateArea = (data?: string) => setArea(data)
            ...
            <div className="modal-wraper ion-padding">
                ...
                <form action="">
                    ...
                    <section className="property-type">
                        ...
                        <IonSegment className='mt-3'>
                            <IonSegmentButton value='home' className='py-3'>
                    ...
                    <section className="range-selection mt-4">
                        ...
                        <IonRange
                            ...
                            step={2}
                            value={propertyPrice}
                            onIonChange={e => updatePropertyPrice(e.detail.value as number)}
                        >
                            <IonLabel slot='start'>10M</IonLabel>
                    ...
                    <section className="range-selection mt-2">
                        ...
                        <IonSegment value={numberOfRooms} onIonChange={e => updateNumberOfRooms(e.detail.value)}>
                            <IonSegmentButton value='' className='py-2'>Any</IonSegmentButton>
                    ...
                    <section className="range-selection mt-2">
                        ...
                        <IonSegment value={numberOfBathrooms} onIonChange={e => updateNumberOfBathrooms(e.detail.value)}>
                            <IonSegmentButton value='' className='py-2'>Any</IonSegmentButton>
                            <IonSegmentButton value='1'>1</IonSegmentButton>
                            <IonSegmentButton value='2'>2</IonSegmentButton>
                            <IonSegmentButton value='3'>3</IonSegmentButton>
                    ...
                    <section className="range-selection mt-2">
                        ...
                        <IonSegment value={area} onIonChange={e => updateArea(e.detail.value)}>
                            <IonSegmentButton value='' className='py-2'>Any</IonSegmentButton>
