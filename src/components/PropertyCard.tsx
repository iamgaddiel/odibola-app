...
const PropertyCard = ({
    ...
    return (
        <>
            <div className="card w-100 my-5" style={{ overflow: "hidden" }}>
                <IonFab horizontal='end' vertical='top'>
                    <IonFabButton color='defualt'>
                        <IonIcon icon={heartOutline} color="light" className='light-text'  />
                    </IonFabButton>
                </IonFab>
                ...
                <div className="card-body">
                    <h5 className="card-title bold">{propertyTitle}</h5>
