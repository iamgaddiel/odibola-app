import { IonTabs, IonTabBar, IonTabButton, IonIcon, IonLabel, IonBadge, IonPage, IonHeader, IonToolbar, IonRouterLink, IonImg, IonContent, IonTab, IonSlides, IonSlide, IonCard, IonCardHeader, IonCardContent, IonCardTitle, IonTitle, IonButtons, IonButton, IonFab, IonFabButton } from '@ionic/react'
import { calendar, personCircle, map, informationCircle, menuOutline, homeOutline, search, heart, barbellOutline, menuSharp, carOutline, heartOutline } from 'ionicons/icons'
